...
// jsdom doesn't ship ResizeObserver, but radix-ui's popover/tooltip primitives
// register one as soon as they mount. A noop class is enough for tests that
// just need the components to render without throwing.
