    ...
    <TooltipPrimitive.Portal>
      <TooltipPrimitive.Content
        ...
        className={cn(
          ...
          // Above popovers and hover cards, not level with dialogs. A popover
          // can contain tooltips (the sidebar account menu does), and at the
          // same layer they rendered behind the menu they belonged to.
          Z_TOOLTIP,
          className
        )}
        {...props}
