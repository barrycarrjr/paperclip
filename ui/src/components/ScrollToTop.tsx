...
/**
 * Floating scroll-to-top button that follows the active page scroller.
 * Stacks just above ScrollToBottom; visible once scrolled past the threshold.
 */
export function ScrollToTop() {
  ...
  useEffect(() => {
    const check = () => {
      setVisible(distanceFromTop(resolveScrollTarget()) > 300);
    };
